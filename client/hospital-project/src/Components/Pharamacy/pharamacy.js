...
import pharamacyimage from '../assets/Pharmacyimage.gif';
import { faArrowRight } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faHeartPulse } from '@fortawesome/free-solid-svg-icons';
import { Link, useParams } from 'react-router-dom';
import pharamacyprofile from '../assets/person1.webp';

export function Pharamacypage(){
        ...
        <>
            ...
            <header className='header'>
                ...
                <section className='home row col' id='profile'>
                    <div className='image'>
                        <img src={pharamacyimage} />
                        {/* <img src={profile}/> */}
                    </div>

                    <div className='content'>
                    <img src={pharamacyprofile} class="img-thumbnail img_siz rounded-5" alt="..."/>
                        <table>
                            <tr>
                        ...
                        <br/>
                        <br/>
                        <Link to='/pharamacypin' className='btn'> Patient prescription form<FontAwesomeIcon icon={faArrowRight} /></Link>
                    </div>
                </section>
        </>
    );
